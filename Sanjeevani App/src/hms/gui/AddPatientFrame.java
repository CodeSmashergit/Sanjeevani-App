...
public class AddPatientFrame extends javax.swing.JFrame {
   ...
   private ArrayList<String> doctor;
    ...
    public String sendSms()
    {
        try
        {
            String apiKey="apikey="+"4mEcwjH5V3U-YIYun2IajHWLcvghdqr0RJ09nhA4ZA";
            String message="&message="+"Your OTP is "+refs+" for Patient Id: "+p_id;
            ...
            rd.close();
            System.out.println("in send sms "+stringBuffer.toString());
