...
//        });
    ...
    private  void loginWork()
    {
       ...
       try
       {
           ...
           if(username!=null)
           {
               ...
               {
                   fr=new ReceptionistOptionsFrame();
                   //r.setVisible(true);
                   
               }
               else
               {
                   fr=new DoctorOptionsFrame();
                   //d.setVisible(true);
               }
               fr.setVisible(true);
               this.dispose();
    ...
    private void initComponents() {
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon("F:\\Icon  project\\user1.png")); // NOI18N

        jLabel9.setIcon(new javax.swing.ImageIcon("F:\\Icon  project\\pass1.png")); // NOI18N
        ...
        jLabel8.setIcon(new javax.swing.ImageIcon("F:\\TechQuizApp\\onlineexam\\animatedlogin.gif")); // NOI18N
    ...
    private void txtUserIdFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtUserIdFocusGained
        if(txtUserId.getText().equals("Username")){
               txtUserId.setText("");
